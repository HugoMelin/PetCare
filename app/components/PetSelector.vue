  ...
  <div ref="dropdownRef" class="relative">
    ...
    >
      <div class="flex-1 text-left overflow-hidden">
        <p
          v-if="selectedPet"
          class="text-sm sm:text-base text-gray-900 truncate"
        >
          {{ selectedPet?.name }}
        </p>
        <div
          v-else
          class="h-5 bg-gray-200 rounded animate-pulse w-1/2 sm:mb-1"
        />
        <p
          v-if="selectedPet"
        ...
        <div
          v-else
          class="hidden sm:block h-5 bg-gray-200 rounded animate-pulse w-3/4"
        />
      </div>
      <IconChevronDown
        :class="`w-5 h-5 text-gray-500 transition-transform flex-shrink-0 ${isOpen ? 'rotate-180' : ''}`"
      />
    </button>
    ...
    >
      <div class="max-h-64 overflow-y-auto">
        ...
        >
          ...
          <div
            v-if="selectedPet.id === petItem.id"
        ...
        <div>
          ...
          >
            ...
            >
              <IconPlus class="w-3 h-3 sm:w-4 sm:h-4" />
            </div>
