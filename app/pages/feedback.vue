...
<template>
  <div class="space-y-6">
    ...
    <Card v-if="isSubmitted">
      ...
      <template #content>
        <p class="text-gray-700 mb-4">
          Votre message a été envoyé avec succès. Nous reviendrons vers vous si
          nécessaire.
        </p>
        <p class="text-gray-700">
          Nous apprécions votre contribution pour améliorer notre application.
        </p>
      </template>
    </Card>

    <Card v-else>
      <template #title> Envoyez-nous votre retour </template>
      <template #content>
        <form class="flex flex-col gap-4" @submit.prevent="handleSubmit">
          <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <button
                ...
                :key="type.value"
                type="button"
                :class="`flex flex-col items-center gap-2 p-4 border-2 rounded-lg transition-all ${
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Décrivez votre retour, suggestion ou problème en détail..."
              required
            />
            <p class="text-sm text-gray-500 mt-1">
    ...
    <Card v-if="!isSubmitted">
      <template #title> 💬 Votre avis compte </template>
      <template #content>
        <div class="space-y-2 text-sm text-gray-600">
          ...
          <p>• Pour les suggestions, expliquez comment cela vous aiderait</p>
          <p>• Pour le support, soyez le plus précis possible</p>
        </div>
      </template>
    </Card>
  </div>
