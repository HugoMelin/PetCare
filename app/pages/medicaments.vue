    ...
    <div class="space-y-4">
      <Card v-for="medication in medications" :key="medication.id">
        <template #content>
          ...
          >
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-3 mb-2">
                ...
                <span
                  :class="[
                    ...
                    isLate(medication?.nextDoseDate)
              ...
              <p class="text-sm text-gray-600">
                Prochaine dose :
                {{
                  new Date(medication?.nextDoseDate).toLocaleDateString("fr-FR")
                }}
              </p>
            </div>
            <ChevronUp
          ...
          <div
            v-if="expandedMedication === medication.id"
            class="mt-6 pt-6 border-t border-gray-200"
          >
            <form
              v-if="editingId === medication.id"
              class="space-y-4"
              @submit.prevent="handleUpdate(medication)"
            >
              <div>
                <label class="block text-gray-700 mb-2 text-sm">
                  Nom du médicament <span class="text-red-600">*</span>
              ...
              <div class="grid sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    :value="
                      medication?.lastDoseDate
                        ? new Date(medication.lastDoseDate)
                            .toISOString()
                            .slice(0, 10)
                        : ''
                    "
                ...
                <div>
                  ...
                  <select
                    v-model="medication.frequencyDays"
                    class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#4CA8E0] focus:border-transparent outline-none transition-shadow"
                  >
                    <option value="7">7 jours</option>
                    <option value="14">14 jours</option>
              ...
              <div class="space-y-4">
                <div class="space-y-3 text-gray-700">
                  ...
                  >
                    ...
                    <span>{{
                      new Date(medication.lastDoseDate).toLocaleDateString(
                        "fr-FR",
                      )
                    }}</span>
                  </div>
                  ...
                  >
                    ...
                    <span>{{
                      new Date(medication.nextDoseDate).toLocaleDateString(
                        "fr-FR",
                      )
                    }}</span>
                  </div>
